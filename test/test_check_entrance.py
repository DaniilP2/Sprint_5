...
class TestAccountEntrance:
    ...
    def test_main_enter_button_entrance(self, open_main_page):
        ...
        order_button = WebDriverWait(driver, 12).until(EC.visibility_of_element_located(Locators.main_order_button))
        assert order_button.is_displayed() is True  # Ждем кнопку "Оформить заказ" на главной странице
